...
public class Restaurants extends Activity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ImageView imageView = (ImageView)findViewById(R.id.add_res);
    ...
    public void install_res(View v){
        Intent i = new Intent(Restaurants.this, install.class);
        startActivity(i);
    }
    ...
    private static final String TAG = Restaurants.class.getSimpleName();
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Restaurants.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void AboutUs() {
        Intent i = new Intent(Restaurants.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Restaurants.this, FindUsActivity.class);
        startActivity(i);
    }
