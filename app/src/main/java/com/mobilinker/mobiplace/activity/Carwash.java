...
public class Carwash extends Activity implements LocationListener {
    ...
    public void install_car(View v){
        Intent i = new Intent(Carwash.this, install.class);
        startActivity(i);
    }
    ...
    private static final String TAG = Carwash.class.getSimpleName();
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Carwash.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(Carwash.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(Carwash.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Carwash.this, FindUsActivity.class);
        startActivity(i);
    }

    private void ListActivity() {
        Intent i = new Intent(this, Carwash.class);
        startActivity(i);
    }
