...
public class Banks extends Activity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ImageView imageView = (ImageView)findViewById(R.id.add_bank);
    ...
    public void install_bank(View v){
        Intent i = new Intent(Banks.this, install.class);
        startActivity(i);
    }
    ...
    private static final String TAG = Banks.class.getSimpleName();
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Banks.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void AboutUs() {
        Intent i = new Intent(Banks.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Banks.this, FindUsActivity.class);
        startActivity(i);
    }
