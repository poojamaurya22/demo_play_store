...
public class Spas extends Activity implements LocationListener {

    @Override
    public void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.spas);

        ImageView imageView = (ImageView)findViewById(R.id.add_spa);
    ...
    public void install_spa(View v){
        Intent i = new Intent(Spas.this, install.class);
        startActivity(i);
    }
    ...
    private static final String TAG = Spas.class.getSimpleName();
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Spas.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(Spas.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(Spas.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Spas.this, FindUsActivity.class);
        startActivity(i);
    }

    private void ListActivity() {
        Intent i = new Intent(this, Spas.class);
        startActivity(i);
    }
