...
public class install extends Activity  implements LocationListener{
    @Override
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(install.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(install.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(install.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(install.this, FindUsActivity.class);
        startActivity(i);
    }
