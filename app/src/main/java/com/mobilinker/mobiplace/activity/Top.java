...
public class Top extends Activity implements LocationListener {
    ...
    LinearLayout home, trends, categories, deals;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Top.this, user.class);
                startActivity(i);
            }
        });


        ImageView imageView = (ImageView)findViewById(R.id.add_top);
        ...
        deals.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Top.this, Deals.class);
                startActivity(i);
            }
        });
        ...
        trends.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Top.this, Trends.class);
                startActivity(i);
            }
        });
        ...
        categories.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Top.this, Categories.class);
                startActivity(i);
            }
        });
    }
    ...
    private void iUI() {
        ...
        atms = (LinearLayout) findViewById(R.id.top_atms);
        ...
        atms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent atm = new Intent(Top.this, Atms.class);
                atm.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(atm);
            }
        });

        cafes = (LinearLayout) findViewById(R.id.top_cafes);
        ...
        cafes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent cafe = new Intent(Top.this, Cafes.class);
                cafe.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(cafe);
            }
        });

        gym = (LinearLayout) findViewById(R.id.top_gym);
        ...
        gym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent gym = new Intent(Top.this, Gym.class);
                gym.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(gym);
            }
        });

        hospitals = (LinearLayout) findViewById(R.id.top_hospitals);
        ...
        hospitals.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent mosque = new Intent(Top.this, Hospital.class);
                mosque.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mosque);
            }
        });

        theater = (LinearLayout) findViewById(R.id.top_theater);
        ...
        theater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent rv_park = new Intent(Top.this, Theater.class);
                rv_park.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(rv_park);
            }
        });

        park = (LinearLayout) findViewById(R.id.top_park);
        ...
        park.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AllConstants.topTitle = "PARK LIST";
                AllConstants.query = "rv_park";
                final Intent rv_park = new Intent(Top.this, Park.class);
                rv_park.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(rv_park);
            }
        });

        police = (LinearLayout) findViewById(R.id.top_police);
        ...
        police.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent police = new Intent(Top.this, Police.class);
                police.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(police);
            }
        });

        school = (LinearLayout) findViewById(R.id.top_school);
        ...
        school.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent school = new Intent(Top.this, Schools.class);
                school.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(school);
            }
        });

        mall = (LinearLayout) findViewById(R.id.top_mall);
        ...
        mall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent shopping_mall = new Intent(Top.this, Malls.class);
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Top.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(Top.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(Top.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Top.this, FindUsActivity.class);
        startActivity(i);
    }
