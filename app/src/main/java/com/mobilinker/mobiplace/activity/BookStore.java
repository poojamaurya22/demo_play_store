...
public class BookStore extends Activity implements LocationListener {

    @Override
    public void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bookstores);

        ImageView imageView = (ImageView)findViewById(R.id.add_book);
    ...
    public void install_book(View v){
        Intent i = new Intent(BookStore.this, install.class);
        startActivity(i);
    }
    ...
    private static final String TAG = BookStore.class.getSimpleName();
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(BookStore.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(BookStore.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(BookStore.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(BookStore.this, FindUsActivity.class);
        startActivity(i);
    }
