...
public class Doctor extends Activity implements LocationListener{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ImageView imageView = (ImageView)findViewById(R.id.add_doc);
    ...
    public void install_doc(View v){
        Intent i = new Intent(Doctor.this, install.class);
        startActivity(i);
    }
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Doctor.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void AboutUs() {
        Intent i = new Intent(Doctor.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Doctor.this, FindUsActivity.class);
        startActivity(i);
    }
