...
public class Hospital extends Activity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ImageView imageView = (ImageView)findViewById(R.id.add_hos);
    ...
    public void install_hos(View v){
        Intent i = new Intent(Hospital.this, install.class);
        startActivity(i);
    }
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Hospital.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void AboutUs() {
        Intent i = new Intent(Hospital.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Hospital.this, FindUsActivity.class);
        startActivity(i);
    }
