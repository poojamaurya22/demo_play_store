...
public class Food extends Activity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ImageView imageView = (ImageView)findViewById(R.id.add_food);
    ...
    public void install_food(View v){
        Intent i = new Intent(Food.this, install.class);
        startActivity(i);
    }
...
//                    .setTitle(getString(R.string.btn_start_location_updates));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_app_list:
                Intent i = new Intent(Food.this, AllAppsActivity.class);
                startActivity(i);
    ...
    private void ShowonMap() {
        Intent i = new Intent(Food.this, MapsActivity.class);
        startActivity(i);
    }
    private void AboutUs() {
        Intent i = new Intent(Food.this, AboutUsActivity.class);
        startActivity(i);
    }
    private void FindUsActivity() {
        Intent i = new Intent(Food.this, FindUsActivity.class);
        startActivity(i);
    }
